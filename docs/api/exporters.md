...
MikuMikuDance `.vmd`), to stepped 2D cue lists (Rhubarb, Moho/OpenToonz,
Papagayo), and to the experimental Bethesda Skyrim `.lip` writer plus its
`.fuz`/`.lip` header tools.
